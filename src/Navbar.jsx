...
function Navbar() {
  ...
  return (
    <div className='bg-slate-200 w-full h-14 flex justify-center items-center font-sans text-sm lg:text-lg text-black drop-shadow-lg'>
      {/* <h2 className='font-sans text-lg font-bold'>ToDoList Maker</h2> */}
      <ul className='flex gap-6 lg:gap-12 font-semibold'>
