    ...
    <div className="flex justify-center w-full pt-32 selection:bg-amber-400 ">
      <div className="w-2/4 h-3/4 flex justify-center items-center gap-3 flex-col">
        ...
        >
          ...
          <button onClick={()=>alert("This feature is not available yet.")} className="w-56 h-14 bg-amber-400 font-semibold rounded-md hover:bg-black hover:text-orange-300">Change email</button>
        </div>
        <div
          id="task"
          className="w-3/5 h-20 border-b-2 flex justify-between items-center font-sans text-x"
        >
          ...
          <button onClick={()=> navigate("/")} className="w-56 h-14 bg-amber-400 font-semibold rounded-md hover:bg-black hover:text-orange-300">Add task</button>
        </div>
        <div
          id="task"
        ...
        >
          ...
          <button onClick={()=>alert("This feature is not available yet.")} className="w-64 h-14 bg-amber-400  font-semibold hover:bg-black rounded-md hover:text-orange-300">Change password</button>
        </div>
      </div>
    </div>
  );
